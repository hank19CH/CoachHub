...
async function loadSessionData() {
  ...
  try {
    ...
    // IMPORTANT: Map ALL structured fields from session_data JSONB — do NOT hardcode null
    exercises.value = sessionExercises.value.map((se, i) => ({
      ...
      duration_seconds: se.duration_seconds ?? null,
      distance_meters: se.distance_meters ?? null,
      rpe: se.rpe ?? null,
      intensity_percent: se.load_percent ?? se.intensity_percent ?? null,
      rest_seconds: se.rest_seconds ?? null,
      target_time_seconds: se.target_time_seconds ?? null,
      notes: se.notes ?? null,
      video_url: null,
