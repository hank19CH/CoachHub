      ...
      },
{
      ...
      {
        name: 'Smart Import',
        description: 'Upload & import programs with AI',
        path: '/coach/import',
        icon: 'upload',
        color: 'bg-peak-500'
      }
  ...
  },
  {
    ...
    items: [
      {
        name: 'Philosophy',
        description: 'AI coaching style analysis',
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div :class="tool.color" class="w-12 h-12 rounded-lg flex items-center justify-center mb-3">
              ...
              <!-- Upload icon -->
              <svg v-else-if="tool.icon === 'upload'" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
